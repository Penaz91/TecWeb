<?php
        $MESSAGES_IT = [
                ...
                "7" => "Attenzione! Chiave inglese (Name, Function) già presente. Inserimento rifiutato.",
                /* Messaggi di OK*/
                ...
                "232" => "Impossibile Eliminare la strumentazione, potrebbe essere sotto noleggio",
        ...
        $MESSAGES_EN = [
                ...
                "7" => "Warning! English key (Name, Function) already in use. Insertion refused.",
                 /* Messaggi di OK*/
                ...
                "232" => "Cannot delete instrumentation, could it be under rental?",
